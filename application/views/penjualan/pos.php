  <script>
...
</script><body class="nav-md" style="padding-right:0px">
              ...
              <div class="modal-body">
                <div class="row" id="debit-1"  style="cursor:pointer" onclick="pilihKartuDebit('debit-1')">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-6" style="text-align: center">
                    <img src="http://localhost/koperasiCihui/images/mandiri-button.png" height="80" width="250">
                  </div>
                  <div class="col-md-3 col-sm-3 col-xs-3"></div>
                </div>
                <div  class="row" id="debit-2" style="cursor:pointer" onclick="pilihKartuDebit('debit-2')">
                  <div class="col-md-3 col-sm-3 col-xs-3"></div>
                  <div class="col-md-6 col-sm-6 col-xs-6" style="text-align: center">
                    <img src="http://localhost/koperasiCihui/images/bca-button.png" height="90" width="250">
                  </div>
                  <div class="col-md-3 col-sm-3 col-xs-3"></div>
                </div>
              </div>
    ...
    <!-- jQuery -->
    <script src="http://localhost/koperasiCihui/vendors/jquery/dist/jquery.min.js"></script>
    <!-- Bootstrap -->
    <script src="http://localhost/koperasiCihui/vendors/bootstrap/dist/js/bootstrap.min.js"></script>
    <!-- FastClick -->
    <script src="http://localhost/koperasiCihui/vendors/fastclick/lib/fastclick.js"></script>
    <!-- NProgress -->
    <script src="http://localhost/koperasiCihui/vendors/nprogress/nprogress.js"></script>

    <!-- Custom Theme Scripts -->
    <script src="http://localhost/koperasiCihui/build/js/custom.min.js"></script>
  </body>
</html>
